...
const amss = new URLSearchParams(window.location.search);
const gale3 = amss.get ("g3");

const aams = new URLSearchParams(window.location.search);
const gale4 = aams.get ("g4");

const aaams = new URLSearchParams(window.location.search);
const gale5 = aaams.get ("g5");
